...
@EnableKafka
@EnableKafkaStreams
public class SyslogKafkaStreamSuccessLogin {
    ...
    public static void main(String[] args) {
        SpringApplication.run(SyslogKafkaStreamSuccessLogin.class, args);
    }

    @Bean
    public KStream<String, SuccessLoginEvent> kStream(StreamsBuilder kStreamBuilder) {
        KStream<String, String> inStream = kStreamBuilder
                .stream(inputTopicName, Consumed.with(Serdes.String(),Serdes.String()));

        KStream<String, SuccessLoginEvent> outStream = inStream
                .mapValues(SuccessLoginEventFactory::toSuccessLoginEvent)
